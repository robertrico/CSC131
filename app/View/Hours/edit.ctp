<div class="col-md-6 col-md-offset-3">
	<div class="hours form panel panel-default">
		<div class="panel-heading">
				<h3 class="panel-title"> <?php echo __('Edit Hours'); ?> </h3>
		</div>
		<div class="panel-body">
			<div class="hours form">
			<?php echo $this->Form->create('Hour'); ?>
				<fieldset>
					<legend><?php echo __('Edit Hours for User'); ?></legend>

						<dl>
							<div class="container col-md-6 col-md-offset-0">
						    	<div class="col-md-3">
						        <p><?php echo $this->Form->input('id');
						        	 echo $this->Form->input('user_id'); ?></p>
						        </div>
