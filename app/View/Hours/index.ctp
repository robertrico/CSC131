<div class="col-md-8 col-md-offset-2">
	<div class="hours index panel panel-default">
		<div class="panel-heading">
				<h3 class="panel-title"> <?php echo __('All Hours'); ?> </h3>
		</div>
		<div class="panel-body">
			<div class="hours index">
				<h2><?php echo __('Records of All Hours'); ?></h2>
				...
				<tr>
					<td><?php echo $this->Html->link(__(h($hour['Hour']['id'])), array('action' => 'view', $hour['Hour']['id'])); ?>&nbsp;</td>
					<td>
