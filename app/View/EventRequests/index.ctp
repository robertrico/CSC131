<div class="eventRequests index">
	<h2><?php echo __('Event Requests'); ?></h2>
	...
	<tr>
		<td><?php echo h($eventRequest['EventRequest']['id']); ?>&nbsp;</td>
		<td><?php echo h($eventRequest['EventRequest']['details']); ?>&nbsp;</td>
		<td><?php echo h($eventRequest['EventRequest']['time']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $eventRequest['EventRequest']['id'])); ?>
